var Vue = (function (exports) {
  ...
  function createReactiveObject(target, isReadonly, baseHandlers, collectionHandlers, proxyMap) {
       ...
       * MFL-TODO
       * 判断当前值是否为对象，不是的话抛出错误
       * isObject基于typeof判断，所以array也是对象
      */
      if (!isObject(target)) {
          {
  ...
  class RefImpl {
      constructor(value, _shallow = false) {
          ...
          /**
           * MFL-TODO
           * convert 判断当前是否为对象，是的话调用reactive
           * _shallow 用来判断当前是否为组件，组件的话
          */
      ...
      set value(newVal) {
          /**
           * MFL-TODO
           * 存的话判断为组件的话newVal，否则toRaw获取原来未被代理的数据
          */
          newVal = this._shallow ? newVal : toRaw(newVal);
          /**
           * MFL-TODO
           * _rawValue 这个是旧值
           * hasChanged 判断新旧值是否改变
          */
  ...
  */
  ...
  function doWatch(source, cb, { immediate, deep, flush, onTrack, onTrigger } = EMPTY_OBJ) {
      ...
      /**
       * MFL-TODO
       * 监听对象可以为数组，但是数组中每一项只能为ref，reactive，function，如果是function会去执行他
       * 监听对象为function直接执行
       * 监听对象为ref则将getter设为他的value
       * 监听对象为reactive，getter设为本身
      */
      if (isRef(source)) {
          getter = () => source.value;
